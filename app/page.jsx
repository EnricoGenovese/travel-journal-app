...
import { Calendar, ChevronRight, Book, Sparkles, Lock, FileText, BarChart2, Divide } from "lucide-react";
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@/components/ui/accordion";
import { Skeleton } from "@/components/ui/skeleton";
import TestimoniaCarousel from "@/components/testimonial-carousel";
...
export default async function Home() {
  ...
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <section id="features" className="mt-24 grid lg:grid-cols-3 gap-8">
